    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        cut_out2(sprf, row, col) {
          var height = sprf.height / col;
          var width = sprf.width / row;
        ...
        sprite_pos() {
          for (var i = 0; i < this.row; i++) {
            for (var j = 0; j < this.col; j++) {// this.spriteN2[i][j].node.setPosition(100, 280, 0); 
            }
          }
        }
...
//# sourceMappingURL=713b5787ad7033fee8e5f33ce6ec9378d01fbcc2.js.map