System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "b55b6ZByr9DQKgVYYyHNZyK", "Game_Turn10", undefined);
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        spawnConfetti() {
          ...
          for (let i = 0; i < 40; i++) {
            ...
            this.node.addChild(particle); // Устанавливаем Z-index повыше (для UI в Cocos 3.x это порядок в иерархии)
...
//# sourceMappingURL=72ec4e342d5da3c2a5af4897878a76eaff1a438b.js.map