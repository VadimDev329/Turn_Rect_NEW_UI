System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, rect, Label, resources, Sprite, SpriteFrame, math, UITransform, Layers, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Game;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "eec917mMbNPVZl92/kr1A+t", "Game_Turn6", undefined);

      __checkObsolete__(['_decorator', 'Component', 'Node', 'Rect', 'rect', 'Label', 'resources', 'Sprite', 'SpriteFrame', 'math', 'EventTouch', 'UITransform', 'Layers']);
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        onTouchStart(event) {
          if (this.isGameOver) return; // В индивидуальной подписке target — это сам кубик
        ...
        _score() {
          ...
          this.node.children.forEach(child => {
            ...
            let currentAngle = Math.round(child.angle) % 360; // В JS % может вернуть -90, поэтому берем абсолютное значение
...
//# sourceMappingURL=0480d77c810c5497ff55a15bdaf679a593b90d1a.js.map