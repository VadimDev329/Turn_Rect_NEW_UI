    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        cut_out(sprf, sprite, row, col) {
          let height_rect = sprf.originalSize.height / col;
          let width_rect = sprf.originalSize.width / row;
        ...
        cut_out2(sprf) {
          let height_image = sprf.originalSize.height;
          let width_image = sprf.originalSize.width;
          let height_rect = height_image / this.col;
          let width_rect = width_image / this.row;
          let x = 0;
          let y = 0;
...
//# sourceMappingURL=55572324f9e47721026f38cc69da0218f98b1f60.js.map