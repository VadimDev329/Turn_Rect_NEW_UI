  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        cut_out4(sprf) {
          let height_image = sprf.originalSize.height; // Высота исходной картинки

          let width_image = sprf.originalSize.width; // Ширина исходной картинки

          let height_rect = height_image / this.col; // Высота вырезаного прямоугольника

          let width_rect = width_image / this.row; // Ширина вырезаного прямоугольника

          let x = 0; // Координата х прямоугольника

          let y = 0; // Координата у прямоугольника

          let m = 0; // Математический результат (random)

          let spr = new SpriteFrame(); // Вспомогательный фрейм

          let sprite = null; // Очередной спрайт
