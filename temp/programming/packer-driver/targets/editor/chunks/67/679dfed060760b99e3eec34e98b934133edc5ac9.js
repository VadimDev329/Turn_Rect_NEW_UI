    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec(_class = class Game extends Component {
        ...
        onLoad() {
          ...
          let self = this; // let context = this;

          let absolutePath = "D:/ENGINES/Cocos/PROJECTS/103/Rect/f3.jpeg";
          let as = assetManager.loadRemote(absolutePath, function (err, imageAsset) {
            const spriteFrame = new SpriteFrame();
            const texture = new Texture2D(); // const sprite = new Sprite();
...
//# sourceMappingURL=679dfed060760b99e3eec34e98b934133edc5ac9.js.map